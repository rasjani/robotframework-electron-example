...
signal_service = ChromeService(executable_path=r"/full/path/to/your/chromedriver/location/chromedriver")

# And here we construct options that point to use your actual electron app.
signal_electron = Options()
signal_electron.binary_location = r"/full/path/to/your/electron/app/YourAppBinaryHere"
